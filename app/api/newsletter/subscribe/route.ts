...
function buildWelcomeEmailHtml(email: string): string {
  ...
  const perks = [
    ...
    ["⚡", "Early drop access", "New strains and limited packs announced to this list first."],
  ...
  html += '<p style="margin:0;font-size:12px;color:#94a3b8;text-align:center;">&copy; ' + new Date().getFullYear() + ' Real Duck Distro. All rights reserved.<br/>HQ: LA, USA · Priority delivery: KY · MI · FL · MS.</p>';
  html += '</td></tr>';
