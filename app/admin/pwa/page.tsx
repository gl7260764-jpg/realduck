...
import { Smartphone, Bell, Users, Gift, Globe, Monitor, Loader2, Clock } from "lucide-react";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        {data.installsByDevice.length > 0 && (
          <div className="bg-white border border-gray-200 rounded-xl p-4 lg:p-5">
            <h2 className="text-sm lg:text-base font-bold text-gray-900 mb-3 flex items-center gap-2"><Monitor className="w-4 h-4" /> Installs by Device</h2>
        ...
        {data.installsByCountry.length > 0 && (
          <div className="bg-white border border-gray-200 rounded-xl p-4 lg:p-5">
            <h2 className="text-sm lg:text-base font-bold text-gray-900 mb-3 flex items-center gap-2"><Globe className="w-4 h-4" /> Installs by Country</h2>
            <div className="space-y-2">
