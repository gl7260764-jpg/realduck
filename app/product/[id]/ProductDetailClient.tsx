                  ...
                  <div className="prose max-w-none">
                    ...
                    <div className="mt-6 p-4 bg-slate-50 rounded-lg border border-slate-100">
                      <p className="text-sm text-slate-700 leading-relaxed">
                        {product.title} is available for delivery across the USA, with fast discreet shipping on all orders. Headquartered in Los Angeles, USA — with priority delivery to Kentucky, Michigan, Florida and Mississippi — every Real Duck Distro product is backed by our commitment to quality. If it&apos;s not premium, we don&apos;t carry it.
                      </p>
                    </div>
                  </div>
                );
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-gray-600 text-sm sm:text-base leading-relaxed">
                  {product.title} is part of the Real Duck Distro premium collection — the world&apos;s leading cannabis lifestyle brand, headquartered in Los Angeles, USA, with priority delivery to Kentucky, Michigan, Florida and Mississippi. Trusted by thousands of customers across the USA, every product is hand-selected for uncompromising quality. We ship discreetly across the entire United States.
                </p>
              </div>
              <div className="relative aspect-video rounded-2xl overflow-hidden shadow-lg bg-gray-100">
                <CloudImage
                  ...
                  alt={`${product.title} - Premium Cannabis | Real Duck Distro USA | Priority delivery to KY, MI, FL, MS`}
                  title={`Premium Cannabis | Real Duck Distro - HQ in Los Angeles · KY/MI/FL/MS priority`}
                  fill
                  loading="lazy"
